...
- 🎓 Pursuing my **M.Sc in Data Science** at VIT Chennai (2025–2027)
- 📊 **B.Sc Statistics** graduate from SDNB Vaishnav College, Chennai
- 💼 Interned at the **Department of Economics and Statistics**, working across Agriculture Statistics and National Income divisions
- 🌱 Currently learning: **Data Structures & Algorithms, REST APIs, and Python backend fundamentals**
- 🔭 Currently working on: AQI & health-risk forecasting, and demand forecasting projects using Python and statistical modeling
- 👯 Looking to collaborate on: **data analysis, machine learning, and Python projects**
- 🤔 Looking for help with: real-world backend/API project ideas and best practices
- 💬 Ask me about: **Python, R, Statistics, Hypothesis Testing, EDA, and ML fundamentals**
- ⚡ Pronouns: she/her
- 📫 Reach me: yaminiduraisamy14@gmail.com
...
**Database:** ![MySQL](https://img.shields.io/badge/SQL-4479A1.svg?style=for-the-badge&logo=mysql&logoColor=white)
